...
if [ -z "$TMUX_POWERLINE_WINDOW_STATUS_CURRENT" ]; then
	TMUX_POWERLINE_WINDOW_STATUS_CURRENT=(
		"#[fg=colour1,bg=terminal,nobold,noitalics,nounderscore]"
		""
		"#[fg=colour0,bg=colour1,nobold,noitalics,nounderscore]"
		"  #W:#I  "
		"#[fg=colour1,bg=terminal,nobold,noitalics,nounderscore]"
		"#{?window_end_flag,,}"
	)
...
if [ -z "$TMUX_POWERLINE_WINDOW_STATUS_STYLE" ]; then
	TMUX_POWERLINE_WINDOW_STATUS_STYLE=(
		"fg=colour0,bg=colour255,nobold,noitalics,nounderscore"
	)
fi
...
if [ -z "$TMUX_POWERLINE_WINDOW_STATUS_FORMAT" ]; then
	TMUX_POWERLINE_WINDOW_STATUS_FORMAT=(
		"#[fg=colour255,bg=terminal,nobold,noitalics,nounderscore]"
		""
		"#[fg=colour0,bg=colour255,nobold,noitalics,nounderscore]"
		"  #I#{?window_flags,#F, } "
		"  #W "
...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		"left 0 4 default_separator no_sep_bg_color no_sep_fg_color both_disable separator_disable"
		"hostname 4 0 "
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		# "weather 6 0  5 6"
		# "cpu 255 0   terminal 255"
		#             "load 1 0  255 1"
		       "vcs_branch 255 0   terminal 255"
		      "vcs_compare 255 0 default_separator no_sep_bg_color no_sep_fg_color both_disable separator_disable"
	       "vcs_revision 255 0 default_separator no_sep_bg_color no_sep_fg_color both_disable separator_disable"
		     "vcs_modified 255 0 default_separator no_sep_bg_color no_sep_fg_color both_disable separator_disable"
		       "vcs_staged 255 0 default_separator no_sep_bg_color no_sep_fg_color both_disable separator_disable"
		       "vcs_others 255 0 default_separator no_sep_bg_color no_sep_fg_color both_disable separator_disable"
		       # "disk_usage 4 0  255 4"
		...
		"right terminal 255 default_separator no_sep_bg_color no_sep_fg_color both_disable separator_disable"
	)
fi
